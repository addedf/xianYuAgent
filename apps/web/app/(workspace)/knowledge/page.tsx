    ...
    <div className="page-stack page-stack-wide">
      <header className="page-header page-header-split">
        ...
        <div className="knowledge-stats" aria-label="知识库摘要">
          <div><strong>{demoKnowledgeEntries.length}</strong><span>当前条目</span></div>
          <div><strong>3</strong><span>待复核候选</span></div>
          <div><strong>2</strong><span>已验证规则</span></div>
        </div>
      </header>
      ...
      <KnowledgeWorkbench initialEntries={demoKnowledgeEntries} />
    </div>
  );
}
